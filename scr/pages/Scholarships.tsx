        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col transform hover:scale-[1.02] transition-transform duration-300">
             ...
             <div className="p-8 md:p-12 flex-grow">
                ...
                <a 
                  href="https://www.educamaisbrasil.com.br/educandario-sodre" 
                  target="_blank" 
                ...
                >
                  Ir para o Educa Mais Brasil <ExternalLink size={18} />
                </a>
             </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col transform hover:scale-[1.02] transition-transform duration-300">
             ...
             <div className="p-8 md:p-12 flex-grow">
                ...
                <a 
                  href="https://querobolsa.com.br/escola/educandario-sodre" 
                  target="_blank" 
                  rel="noopener noreferrer"
